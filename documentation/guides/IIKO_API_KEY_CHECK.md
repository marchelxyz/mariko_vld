...
# Обновить через API
curl -X POST "https://your-test-app.example.com/api/db/add-iiko-config?key=mariko-iiko-setup-2024" \
  -H "Content-Type: application/json" \
...
curl "https://your-test-app.example.com/api/db/check-terminal-groups?key=mariko-iiko-setup-2024&restaurantId=zhukovsky"
