...
const RestaurantReviews = ({ restaurantId, restaurantName }: RestaurantReviewsProps) => {
  ...
  return (
    <div className="bg-mariko-secondary rounded-[45px] p-6">
      ...
      <div className="space-y-4 max-h-96 overflow-y-auto">
        {reviews.map((review) => {
          // Определяем цветовую схему в зависимости от тональности
          ...
          return (
            ...
            <p className="text-white/90 font-el-messiri text-sm leading-relaxed">
              {review.text}
            </p>
            ...
            {review.managerResponse && (
              <div className="mt-3 bg-white/5 rounded-xl p-3 border-l-3 border-yellow-400">
                ...
                <p className="text-white/80 font-el-messiri text-sm">
                  {review.managerResponse}
                </p>
              </div>
            )}
        ...
        <div className="mt-6 pt-4 border-t border-white/20">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-white/60 text-xs">Позитивных</p>
            </div>
            <div>
              <p className="text-yellow-400 font-bold text-lg">{stats.neutral}</p>
              <p className="text-white/60 text-xs">Нейтральных</p>
            </div>
            <div>
              <p className="text-red-400 font-bold text-lg">{stats.negative}</p>
              <p className="text-white/60 text-xs">Негативных</p>
            </div>
          </div>
        </div>
      )}
