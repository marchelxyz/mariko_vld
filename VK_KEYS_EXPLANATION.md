# VK Mini App ключи - нужны ли они?

## Краткий ответ: **НЕТ, сейчас не нужны**

В текущей реализации приложения VK ключи (Защищённый ключ и Сервисный ключ) **не используются** и **не требуются** для работы Mini App.
