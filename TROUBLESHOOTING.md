...
**Последнее обновление:** 2026-04-03 00:14
...
4. В `frontend/src/features/cart/CartDrawer.tsx` добавить явную кнопку `Скрыть клавиатуру`, которая появляется при фокусе на поле формы и снимает фокус с активного input/textarea/select.
...
- в Mini App открыть checkout и убедиться:
  ...
  - при фокусе на поле появляется `Скрыть клавиатуру`;
