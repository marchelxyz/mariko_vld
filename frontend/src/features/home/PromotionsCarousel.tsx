...
export const PromotionsCarousel = ({
  ...
  if (!slideCount) {
    return (
      <div className="relative w-full mx-auto">
        <div className="relative w-full select-none overflow-hidden rounded-[20px] border border-white/20 bg-white/10 shadow-[0_20px_55px_rgba(0,0,0,0.35)] backdrop-blur-lg aspect-[5/3] md:h-[220px] md:w-[293px] md:aspect-auto lg:h-[220px] lg:w-[293px]">
  ...
  return (
    <div className="relative w-full mx-auto">
      <div
        className="relative w-full select-none overflow-hidden rounded-[20px] border border-white/20 bg-white/10 shadow-[0_20px_55px_rgba(0,0,0,0.35)] backdrop-blur-lg aspect-[5/3] md:h-[220px] md:w-[293px] md:aspect-auto lg:h-[220px] lg:w-[293px]"
