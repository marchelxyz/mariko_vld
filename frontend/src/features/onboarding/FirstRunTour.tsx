...
const STEPS: TourStep[] = [
  ...
  {
    id: "delivery",
    selector: '[data-onboarding="delivery"]',
    title: "Доставка",
    description: "Закажите доставку — вся информация по адресу и времени внутри приложения.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
  {
    id: "review",
    selector: '[data-onboarding="review"]',
    title: "Отзывы",
    description: "Оставляйте отзыв — это помогает нам становиться лучше.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
  {
    id: "about",
    selector: '[data-onboarding="about"]',
    title: "Как нас найти",
    description: "Адрес, маршрут и контакты ресторана — всё в одном месте.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
  {
    id: "promotions",
    selector: '[data-onboarding="promotions"]',
    title: "Акции",
    description: "Следите за новыми акциями и спецпредложениями.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
  {
    id: "menu",
    selector: '[data-onboarding="menu"]',
    title: "Меню",
    description: "Изучайте меню, добавляйте блюда и собирайте заказ заранее.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
  {
    id: "franchise",
    selector: '[data-onboarding="nav-franchise"]',
    title: "Франшиза",
    description: "Вкладка с полной информацией о франшизе и контактами.",
    preferredPlacement: "top",
    highlightRadius: 16,
    highlightPadding: 10,
  },
